...
final class Frame implements Protocols\IFrame
{
	...
	public const CLOSE_PROTOCOL = 1002;
	public const CLOSE_BAD_DATA = 1003;
	public const CLOSE_NO_STATUS = 1005;
	public const CLOSE_ABNORMAL = 1006;
	public const CLOSE_BAD_PAYLOAD = 1007;
	public const CLOSE_POLICY = 1008;
	public const CLOSE_TOO_BIG = 1009;
	public const CLOSE_MAND_EXT = 1010;
	public const CLOSE_SRV_ERR = 1011;
	...
	public function isMasked(): bool
	{
		if ($this->secondByte === -1) {
			throw new UnderflowException(sprintf('Not enough bytes received (%s) to determine if mask is set', $this->bytesReceived));
		}
	...
	public function maskPayload(?string $maskingKey = null)
	{
		...
		if (extension_loaded('mbstring') && mb_check_encoding($maskingKey, 'US-ASCII') !== true) {
